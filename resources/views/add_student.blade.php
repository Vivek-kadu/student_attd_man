            ...
            <div class="py-4 px-8 flex-column items-center justify-center">
                ...
                <div class="mb-4">
                    ...
                    <select name="course_name" id="course_name" class="rounded">
                        ...
                        @foreach($stu_course as $rows_crs)<option value="{{ $rows_crs->id }}">{{ $rows_crs->course_name }}</option>@endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select name="division_name" id="division_name">
                        ...
                        @foreach($stu_division as $rows_div)<option value="{{ $rows_div->id }}">{{ $rows_div->division_name }}</option>@endforeach
                    </select>
                    <!-- <input class=" border rounded w-60 py-2 px-3 text-grey-darker" type="text" name="course_name" id="course_name" value="" placeholder="Enter Your Course name"> -->
                    <!-- <p id=error_creater_id></p> -->
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select name="semester_name" id="semester_name">
                        ...
                        @foreach($stu_semester as $rows_sem)<option value="{{ $rows_sem->id }}">{{ $rows_sem->semester_name }}</option>@endforeach
                    </select>
                    <!-- <input class=" border rounded w-60 py-2 px-3 text-grey-darker" type="text" name="course_name" id="course_name" value="" placeholder="Enter Your Course name"> -->
                    <!-- <p id=error_creater_id></p> -->
                </div>
                ...
                <div class="mb-4">
                    ...
                    MALE <input class=" border rounded w-60 py-2 px-3 text-grey-darker" type="radio" name="gender" id="gender" value="MALE" placeholder="Enter Your gender name">
                    FEMALE <input class=" border rounded w-60 py-2 px-3 text-grey-darker" type="radio" name="gender" id="gender" value="FEMALE" placeholder="Enter Your gender name">
                    OTHER <input class=" border rounded w-60 py-2 px-3 text-grey-darker" type="radio" name="gender" id="gender" value="OTHER" placeholder="Enter Your gender name">
                    <!-- <p id=error_creater_id></p> -->
                </div>
